...
<table>
  <tr>
    ...
    <td style="text-align: center;">
      <h4 style="margin: 0;">Heart Disease Prediction Model</h4>
      <a href="https://github.com/juliamartin0/pharma_sales.git">
...
<table>
  <tr>
    ...
    <td style="text-align: center;">
      <div style="width: 300px; margin: auto;">
        <h4 style="margin: 10px 0; font-size: 16px; text-align: center;">Heart Disease Prediction Model</h4>
        <a href="https://github.com/juliamartin0/pharma_sales.git">
          <img src="https://e-quironsalud.es/255-large_default/consulta-de-cardiologia-electrocardiogra-ecocardiograma.webp" alt="10-Year Heart Disease Prediction Using Logistic Regression" width="400" />
        </a>
      </div>
    </td>
  </tr>
